...
<body>
    ...
    <div id="contenedor">
        ...
        <form name="b" action="<?php echo e(route('usuarios.store')); ?>" method="POST" enctype="multipart/form-data">
...
</html><?php /**PATH C:\srv\laravel\starwars\resources\views/usuarios/index3.blade.php ENDPATH**/ ?>