...
<head>
    ...
    <link href="<?php echo e(asset('css/index2.css')); ?>" rel="stylesheet" type="text/css" >
...
<body>
    ...
    <header style="z-index:200;height:80px; position:sticky; top:0; display:inline-block; width:100%;">
        ...
        <ul style="display:inline-block; float:right; padding-top:20px;">
            <a href="<?php echo e(route('inicio')); ?>" ><li style="border-bottom:1px solid white;">HOME</li></a>
            <a href="<?php echo e(route('peliculas')); ?>"><li>PELICULAS</li></a>
            <a href="<?php echo e(route('naves.index')); ?>"><li>NAVES</li></a>
        </ul>
    </header>
    ...
    <div id="contenido" style="width:100%; height:100%; position:absolute; top:0; z-index:2;">
        ...
        <a id="abajo" href="#segundo" style="position:absolute; bottom:5%; left:7%; background-color: #CB2940; width:100px; height:100px; border-radius:50px; text-align:center; cursor:pointer; text-decoration:none; color:white; box-shadow:10px 5px 20px black"><i class="fas fa-arrow-down" style="font-size:5em;padding-top:20px;"></i></a>
...
</html><?php /**PATH C:\srv\laravel\starwars\resources\views/inicio.blade.php ENDPATH**/ ?>