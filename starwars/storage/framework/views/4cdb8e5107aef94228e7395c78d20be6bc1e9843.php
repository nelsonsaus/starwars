...
<body ng-app="starwars">
    ...
    <header style="z-index:200; border:1px solid black; background-color:#37343B; height:80px; position:sticky; top:0; display:inline-block; width:100%;">
        ...
        <ul style="display:inline-block; float:right; padding-top:20px;">
            <li class="linav"><a href="<?php echo e(route('index2')); ?>" >HOME</a></li>
            <li class="linav"><a href="<?php echo e(route('index')); ?>">PELICULAS</a></li>
            <li class="linav" style="border-bottom:1px solid white;"><a href="<?php echo e(route('naves.index')); ?>">NAVES</a></li>
        </ul>
...
<?php /**PATH C:\srv\laravel\starwars\resources\views/welcome.blade.php ENDPATH**/ ?>