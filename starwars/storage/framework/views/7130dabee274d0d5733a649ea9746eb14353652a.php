...
<head>
    ...
    <script src="<?php echo e(secure_asset('angular/controller.js')); ?>" defer></script>
    <script src="<?php echo e(secure_asset('wow/wow.min.js')); ?>"></script>
    <title>Naves</title>

    <link href="<?php echo e(asset('css/welcome.css')); ?>" rel="stylesheet" type="text/css" >
...
<body ng-app="starwars">
    ...
    <header style="z-index:200; border:1px solid black; background-color:#37343B; height:80px; position:sticky; top:0; display:inline-block; width:100%;">
        ...
        <ul style="display:inline-block; float:right; padding-top:20px;">
            <a href="<?php echo e(route('inicio')); ?>" ><li class="linav">HOME</li></a>
            <a href="<?php echo e(route('peliculas')); ?>"><li class="linav">PELICULAS</li></a>
            <a href="<?php echo e(route('naves.index')); ?>"><li class="linav" style="border-bottom:1px solid white;">NAVES</li></a>
        </ul>
            ...
            <div class="carousel-inner" style="width:100%; height:100%;padding-top:200px;">
                    ...
                    <!--!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!-->
                        ...
                        <div class="contenedor2" class="col-md-6">
                                    ...
                                    <img class="primero" src="<?php echo e(asset('storage/img/naves/default.png')); ?>">
                                    <img src="<?php echo e(asset('storage/img/naves/default.png')); ?>"">
                            ...
                            <div id="shadowTarjeta">
                                ...
                                <div id="backgroundTarj"></div>
                                    ...
                                    <h5 id="nave<?php echo e($naves[0]->id); ?>"></h5>


                                    <p class="precio" id="precio<?php echo e($naves[0]->id); ?>">
                                    </p>
                            ...
                            <div class="bloquePilotos">
                                ...
                                <div class="bloquePorPiloto" id="divPilotosNav<?php echo e($naves[0]->id); ?>">

                                    <?php $__currentLoopData = $navespi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $navespil): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                        <?php if($naves[0]->id == $navespil->nave_id): ?>
                                            <div style="border-bottom:1px solid white; background-color:242424">
                                                <p id="piloto<?php echo e($navespil->id); ?>" style="position:relative;margin-bottom:50px;">

                                                    <button id="btnBor<?php echo e($navespil->nave_id); ?>_<?php echo e($navespil->piloto_id); ?>" type="submit" style="position:absolute;right:10%;top:0%" class="btn btn-danger">
                                ...
                                <div style="margin-top:3%; height:100%;">
                                    <select id="seleccion<?php echo e($naves[0]->id); ?>" ng-options="option as option.nombre for option in data.options track by option.id"
                                            ...
                                            <button class="enviar" type="submit" id="btnEnviar<?php echo e($naves[0]->id); ?>" name="enviar">AÑADIR</button>
                    ...
                    <?php $__currentLoopData = $naves; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nave): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($nave!=$naves[0]): ?>
                    ...
                    <div class="contenedor2" class="col-md-6">
                        ...
                        <div id="shadowTarjeta">
                            ...
                            <div id="backgroundTarj"></div>
                                ...
                                <h5 id="nave<?php echo e($nave->id); ?>"></h5>


                                <p class="precio" id="precio<?php echo e($nave->id); ?>">
                                </p>
                        ...
                        <div class="bloquePilotos">
                            ...
                            <div class="bloquePorPiloto" id="divPilotosNav<?php echo e($nave->id); ?>">

                                <?php $__currentLoopData = $navespi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $navespil): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                    <?php if($nave->id == $navespil->nave_id): ?>
                                        <div style="border-bottom:1px solid white; background-color:242424">
                                            <p id="piloto<?php echo e($navespil->id); ?>" style="position:relative;margin-bottom:50px;">
                            ...
                            <div style="margin-top:3%; height:100%;">
                                <select id="seleccion<?php echo e($nave->id); ?>" ng-options="option as option.nombre for option in data.options track by option.id"
                                            ng-model="data.selected" class="form-control" style="color:white; width:60%;margin-left:30px;display:inline-block; border:2px solid #a32133; background-color:#242424">
                                        </select>

                                        <button type="submit" id="btnEnviar<?php echo e($nave->id); ?>" name="enviar" style="width:30%; height:10%; border-radius:20px; background-color:#CB2940; color:white; font-weight:bold; box-shadow: 0px 17px 15px -8px #CB2940">AÑADIR</button>
                                        <!--LO DEL ONCLICK SE LO PONEMOS CON LO DE JAVASCRIPT-->
                            </div>
...
<?php /**PATH C:\srv\laravel\starwars\resources\views/naves.blade.php ENDPATH**/ ?>