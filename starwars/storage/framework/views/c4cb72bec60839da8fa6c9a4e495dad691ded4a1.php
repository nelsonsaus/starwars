    ...
    <div style="width:100%; height:100%; position:relative;">
        ...
        <header style="z-index:200; border:1px solid black; z-index:13; background-color:#37343B; height:80px; position:sticky; top:0; display:inline-block; width:100%;">
            ...
            <ul style="display:inline-block; float:right; padding-top:20px;">
                <a href="<?php echo e(route('index2')); ?>" ><li class="linav">HOME</li></a>
                <a href="<?php echo e(route('index')); ?>"><li class="linav" style="border-bottom:1px solid white;">PELICULAS</li></a>
                <a href="<?php echo e(route('naves.index')); ?>"><li class="linav">NAVES</li></a>
            </ul>
                ...
                <div id="panel1" class="carousel-item active">
                    ...
                    <div class="div1" style="width:85%; height:76%; border:8px solid black; border-radius:7px; position:absolute; top:0%; left:0%; right:0%; bottom:0%; margin:auto; background-image: url('storage/img/naves/dos.jpg'); background-size:cover;">
                        ...
                        <div id="bloqueBtn1" style="visibility:hidden; width:50%; height:100%; float:right;position:relative">
                                ...
                                <p>Los Últimos Jedi comienza inmediatamente después de los acontecimientos de Star Wars: Episodio VII El Despertar de la Fuerza, establecida treinta años después de la conclusión de la trilogía original de Star Wars. Continúa la historia de Rey y su descubrimiento del exiliado Maestro Jedi Luke Skywalker, junto con la historia de la guerra entre la Resistencia de la General Leia Organa y la Primera Orden. </p>
...
function btn1(){
    ...
    if(screen.availWidth<=905)
        capa1.style="visibility:visible; background-color:black; opacity:0.3; width:100%; height:100%; position:absolute; z-index:10;"
    else if(screen.availHeight<=636)
        capa1.style="visibility:visible; background-color:black; opacity:0.3; width:100%; height:100%; position:absolute; z-index:10;"
    else
    ...
    setTimeout(() => {
        if(screen.availWidth<=905)
            bloqueBtn1.style="visibility:visible; width:100%; height:100%; position:relative";
        else if(screen.availHeight<=636)
            bloqueBtn1.style="visibility:visible; width:100%; height:100%; position:relative";
        else
...
function btn2(){
    ...
    if(screen.availWidth<=905)
        capa2.style="background-color:black; opacity:0.3; width:100%; height:100%; position:absolute; z-index:10;"
    else if(screen.availHeight<=636)
        capa2.style="background-color:black; opacity:0.3; width:100%; height:100%; position:absolute; z-index:10;"
    else
    ...
    setTimeout(() => {
        if(screen.availWidth<=905)
            bloqueBtn2.style="width:100%; height:100%; position:relative";
        else if(screen.availHeight<=636)
            bloqueBtn2.style="width:100%; height:100%; position:relative";
        else
...
function btn3(){
    ...
    if(screen.availWidth<=905)
        capa3.style="background-color:black; opacity:0.3; width:100%; height:100%; position:absolute; z-index:10;"
    else if(screen.availHeight<=636)
        capa3.style="background-color:black; opacity:0.3; width:100%; height:100%; position:absolute; z-index:10;"
    else
    ...
    setTimeout(() => {
        if(screen.availWidth<=905)
            bloqueBtn3.style="width:100%; height:100%; position:relative";
        else if(screen.availHeight<=636)
            bloqueBtn3.style="width:100%; height:100%; position:relative";
        else
...
function btnOcultar(){
    ...
    if(screen.availWidth<=905){
        ...
        capa1.style="visibility:hidden; background-color:black; opacity:0.3; width:100%; height:100%; position:absolute; z-index:10;";
        capa2.style="visibility:hidden; background-color:black; opacity:0.3; width:100%; height:100%; position:absolute; z-index:10;";
        capa3.style="visibility:hidden; background-color:black; opacity:0.3; width:100%; height:100%; position:absolute; z-index:10;";




        bloqueBtn1.style="visibility:hidden; width:100%; height:100%; position:relative";
        bloqueBtn2.style="visibility:hidden; width:100%; height:100%; position:relative";
        bloqueBtn3.style="visibility:hidden; width:100%; height:100%; position:relative";
        ...
        bloqueBtn1.style="visibility:hidden; width:50%; height:100%; position:relative";
        bloqueBtn2.style="visibility:hidden; width:50%; height:100%; position:relative";
        bloqueBtn3.style="visibility:hidden; width:50%; height:100%; position:relative";
...
<?php /**PATH C:\srv\laravel\starwars\resources\views/index.blade.php ENDPATH**/ ?>