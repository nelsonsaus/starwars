...
<body>
    ...
    <header style="z-index:200;height:80px; position:sticky; top:0; display:inline-block; width:100%;">
        ...
        <ul style="display:inline-block; float:right; padding-top:20px;">
            <a href="<?php echo e(route('index2')); ?>" ><li style="border-bottom:1px solid white;">HOME</li></a>
            <a href="<?php echo e(route('index')); ?>"><li>PELICULAS</li></a>
...
</html><?php /**PATH C:\srv\laravel\starwars\resources\views/index2.blade.php ENDPATH**/ ?>