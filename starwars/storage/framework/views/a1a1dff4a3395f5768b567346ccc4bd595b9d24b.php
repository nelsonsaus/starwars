...
<head>
    ...
    <link href="<?php echo e(asset('css/index3.css')); ?>" rel="stylesheet" type="text/css" >

</head>
<body>

        <?php if($text=Session::get('mensaje')): ?>
            <div style="background-color: #549e68; color:white; text-align:center; width:300px; height:80px; position:absolute; z-index:999999; bottom:0%; left:7%;">
                <p style="color:white; padding-top:7%; font-weight:bold;"><?php echo e($text); ?></p>
            </div>
        <?php elseif($text=Session::get('error')): ?>
    ...
    <div id="contenedor">
        ...
        <form name="form1" action="<?php echo e(route('usuarios.login')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
        ...
        <form name="form2" action="<?php echo e(route('usuarios.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\srv\laravel\starwars\resources\views/login.blade.php ENDPATH**/ ?>