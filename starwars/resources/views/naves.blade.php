    ...
    <header style="z-index:200; border:1px solid black; background-color:#37343B; height:80px; position:sticky; top:0; display:inline-block; width:100%;">
        ...
        <div id="contenedor">
            ...
            <div style="position:relative;margin-bottom:100px">
                ...
                <div id="carouselExampleIndicators" class="carousel" style="background-image: url('{{asset('img/naves/planet.jpg')}}');">
                    <div></div>
                    <form class="filter">
                        <input class="form-control" style="width:500px;z-index:9990; position:absolute; top:3%; left:0; right:0; margin:auto; color:black;" type="text" id="slidename" onkeyup="searchbyname()" placeholder="Busca por nombre"/>
                    </form>
                    ...
                    <div class="carousel-item active" name="{{$naves[0]->nombre}}" style="width:100%; height:100%;">
                    ...
                    <!--!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!-->
                        ...
                        <div class="contenedor2" class="col-md-6">
                                    ...
                                    <img id="imgAbajo" class="primero" src="{{asset('img/naves/default.png')}}">
                    ...
                    @if($nave!=$naves[0])
                    <div class="carousel-item" name="{{$nave->nombre}}" style="width:100%; height:100%;">
...
<script>
    ...
    function searchbyname() {
        var input, filter, ul, li, a, i, txtValue,txtValue2,auxPrimera;
        var controles;
        var encontrado=false;
        input = document.getElementById('slidename');
        filter = input.value.toUpperCase();
        ul = document.getElementsByClassName("carousel-inner")[0];
        li = ul.getElementsByClassName('carousel-item');
        controlesPrev = document.getElementsByClassName("carousel-control-prev");
        controlesNext = document.getElementsByClassName("carousel-control-next");
        for(let prev = 0; prev < controlesPrev.length; prev++)
            controlesPrev[prev].style="display:none";
        for(let prev = 0; prev < controlesPrev.length; prev++)
            controlesNext[prev].style="display:none";
        ...
        for (i = 0; i < li.length; i++) {
            ...
            if(filter==""){
                ...
                for (i = 1; i < li.length; i++) {
                    ...
                    for(let prev = 0; prev < controlesPrev.length; prev++)
                        controlesPrev[prev].style="";
                    for(let prev = 0; prev < controlesPrev.length; prev++)
                        controlesNext[prev].style="";
                }
            }else{
                if (txtValue.toUpperCase().indexOf(filter) > -1) {

                    if(auxPrimera!=filter){
                        if(txtValue.includes(filter)){

                            if(!encontrado){
                                li[i].classList.add("active");
                                document.querySelector("#imgAbajo").setAttribute("style", "visibility:visible");
                                console.log(li[i].querySelector("#imgAbajo").getAttribute("style"));
                            }

                            
                            for (j = 0; j < li.length; j++) {
                                if(i!=j){
                                    li[j].querySelector("#imgAbajo").style="visibility:hidden;";
                                }
                            }
                            encontrado=true;
