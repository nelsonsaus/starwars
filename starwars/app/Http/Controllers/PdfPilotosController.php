...
class PdfPilotosController extends Controller
{
    ...
    function BasicTable($pilotos)
    {
            ...
            $this->fpdf->setY(45);
            $this->fpdf->Cell(30,5,utf8_decode("Datos Pilotos"),0, 1);
            ...
            $this->fpdf->Cell(20);
            $this->fpdf->Cell(30,0,"NOMBRE PILOTO",0, 1);
            $this->fpdf->setY(53.5);
            $this->fpdf->Cell(70);
            $this->fpdf->setFillColor(6,117,50); 
            $this->fpdf->SetTextColor(250,250,250);
            $this->fpdf->SetFont('Arial','BI', 9);
            $this->fpdf->Cell(55,5,"URL DEL PILOTO",0, 1, 'C', true);
            $this->fpdf->SetTextColor(6,117,50);
            $this->fpdf->setY(56);
            $this->fpdf->Cell(146);
            $this->fpdf->Cell(20,0,"FECHA CREACION",0, 1);
            $this->fpdf->setY(53);
            $this->fpdf->Cell(170);
            $this->fpdf->setY(60);
            $this->fpdf->setFillColor(6,117,50); 
            ...
            foreach($pilotos as $piloto)
            {
                        ...
                        $this->fpdf->SetTextColor(0,0,0);
                        $this->fpdf->Cell(1);
                        $this->fpdf->Cell(10,5,$piloto->id,0);
                        $this->fpdf->Cell(10);
                        $this->fpdf->Cell(30,5,utf8_decode($piloto->nombre),0);
                        $this->fpdf->Cell(25);
                        $this->fpdf->Cell(5,5,$piloto->url,0);
                        // $this->Cell(2);
                        ...
                        $this->fpdf->Cell(67);
                        $this->fpdf->Cell(5,5,$piloto->created_at,0,1);
                        $this->fpdf->Cell(45);
                ...
                $cont++;
                $importetotal+=$piloto->precio;
            }


            $this->fpdf->SetFont('Arial','BIU', 11);
            $this->fpdf->SetTextColor(0, 0, 0);
            $this->fpdf->Cell(183,12,utf8_decode("TOTAL (". $cont . ") ". "PILOTOS"),0, 1, 'R');
    ...
    public function cuerpo($pilotos){
        $this->fpdf->AddPage();
        $this->fpdf->SetFont('Arial','B',14);
        $this->fpdf->Cell(0,12,'STARWARS',0,1);
        $this->fpdf->Cell(0,10,utf8_decode("NUESTROS PILOTOS"),0,1);
